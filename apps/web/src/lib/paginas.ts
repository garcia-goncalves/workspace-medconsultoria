...
export const PAGINAS: Pagina[] = [
  ...
  { label: "Funil de Vendas", icon: Filter, to: "/funil-de-vendas", minRole: "FUNCIONARIO", grupo: "Negócio", keywords: ["funil", "leads", "oportunidades", "pipeline", "negocios", "funil de vendas", "vendas"] },
